...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private int mMenuIconExpanded;
    private int mMenuExpandedColor;
    private int mBackUpNormalColor;
    private int mMenuIconBackUp;
    private int mMenuColorPressedExpanded;
    private int mMenuColorPressedBackup;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonColorNormal = attr.getColor(R.styleable.FloatingActionsMenu_fab_menuButtonColorNormal, getColor(android.R.color.holo_blue_dark));
        mAddButtonColorPressed = attr.getColor(R.styleable.FloatingActionsMenu_fab_menuButtonColorPressed, getColor(android.R.color.holo_blue_light));
        mAddButtonSize = attr.getInt(R.styleable.FloatingActionsMenu_fab_menuButtonSize, FloatingActionButton.SIZE_NORMAL);
        mAddButtonStrokeVisible = attr.getBoolean(R.styleable.FloatingActionsMenu_fab_addButtonStrokeVisible, true);
        mExpandDirection = attr.getInt(R.styleable.FloatingActionsMenu_fab_expandDirection, EXPAND_UP);
        mLabelsStyle = attr.getResourceId(R.styleable.FloatingActionsMenu_fab_labelStyle, 0);
        mLabelsPosition = attr.getInt(R.styleable.FloatingActionsMenu_fab_labelsPosition, LABELS_ON_LEFT_SIDE);

        mMenuIcon = attr.getResourceId(R.styleable.FloatingActionsMenu_fab_menuButtonIcon, 0);
        mMenuIconExpanded = attr.getResourceId(R.styleable.FloatingActionsMenu_fab_menuButtonIconExpanded, 0);
        mMenuExpandedColor = attr.getColor(R.styleable.FloatingActionsMenu_fab_menuButtonColorNormalExpanded, 0);
        mMenuColorPressedExpanded = attr.getColor(R.styleable.FloatingActionsMenu_fab_menuButtonColorPressedExpanded, 0);
        attr.recycle();
    ...
    private void createAddButton(Context context) {
        if (mMenuIcon == 0) {
            ...
            mMenuButton.setIcon(mMenuIcon);
            mMenuButton.setColorPressed(mAddButtonColorPressed);
            mMenuButton.setColorNormal(mAddButtonColorNormal);
        }
    ...
    private void collapse(boolean immediately) {
        if (mExpanded) {
            ...
            if (mMenuExpandedColor != 0) {
                mMenuButton.setColorNormal(mBackUpNormalColor);
            }

            if (mMenuIconExpanded != 0) {
                mMenuButton.setIcon(mMenuIconBackUp);
            }

            if (mMenuColorPressedExpanded != 0) {
                mMenuButton.setColorPressed(mMenuColorPressedBackup);
            }
        }
    }
    ...
    public void expand() {
        if (!mExpanded) {
            ...
            if (mMenuExpandedColor != 0) {
                mBackUpNormalColor = mMenuButton.mColorNormal;
                mMenuButton.setColorNormal(mMenuExpandedColor);
            }

            if (mMenuIconExpanded != 0) {
                mMenuIconBackUp = mMenuButton.mIcon;
                mMenuButton.setIcon(mMenuIconExpanded);
            }

            if (mMenuColorPressedExpanded != 0) {
                mMenuColorPressedBackup = mMenuButton.getColorPressed();
                mMenuButton.setColorPressed(mMenuColorPressedExpanded);
            }
        }
    }
